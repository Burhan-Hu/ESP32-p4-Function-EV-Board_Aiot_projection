...
/* Disabled on ESP32-P4: the SIMD resize path crashes when the source buffer
     * resides in PSRAM (Load access fault in
     * resize_nn_simd_helper_rgb565le2rgb888_qint8).  The scalar fallback is
     * fast enough for a 4 fps detection loop. */
